      ...
      <div className="max-w-md w-full z-10">
        ...
        <div className="bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-2xl shadow-slate-200 border border-white">
          ...
          <div className="mt-8 pt-8 border-t border-slate-50 text-center">
             <p className="text-slate-500 text-xs font-medium">Don't have an account? <span className="text-primary-500 font-bold hover:underline cursor-pointer">Contact System Admin</span></p>
          </div>
        </div>
